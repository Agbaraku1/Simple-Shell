...
/**
 * ctrl_c - it ignores Ctrl-C input and prints prompt again
...
/**
 * ignore_space - it returns string without spaces in front
 * @str: string
 * Return: new string
 */
...
/**
 * ctrl_D - it exits program if Ctrl-D was pressed
 * @i: characters read via get_line
 * @command: user's typed in command
 * @env: the env_ var linked list
 */
...
/**
 * prompt - it repeats prompts on user and executes user's cmds if applicable
