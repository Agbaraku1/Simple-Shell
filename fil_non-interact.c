...
/**
 * c_ignore - it custom ignores spaces and newlines
 * (e.g. echo "ls\n ls" | ./a.out)
 * @str: envrionmental variables for strings
 * Return: new string
 */
...
/**
 * non_interactive - it handles user pipes cmds into shell via pipeline
