#include "shell.h"
/**
 * c_t_size -will the return number of delim
...
/**
 * c_str_tok - will tokenize a string even the delim with empty string
 * @str: is the user's command typed into the  shell
 * @delm: is the  delimeter
